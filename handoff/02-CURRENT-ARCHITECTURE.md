...
- Синхронизация с защитой от затирания: ревизия `meta.rev` в блобе, проверка перед записью и сверка при возврате во вкладку, окно разрешения конфликта, живой статус (детали — в 06-DECISIONS-LOG).
